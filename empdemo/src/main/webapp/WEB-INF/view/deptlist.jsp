        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach items="${pageInfo.list}" var="dept" varStatus="index">
                <tr>
                    ...
                    <td>${dept.location}</td>
                    <td>
                        <button type="button" class="btn btn-info update-btn" value="${dept.id}">修改</button>
                        <button type="button" class="btn btn-danger delete-btn" value="${dept.id}">删除</button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".deleteAll").click(function () {
            ...
            path = "${pageContext.request.contextPath}/dept/deleteDeptById?id=" + ids;
            location.href = path;
        });
